...
| 🔴 | P1 | [#1](https://github.com/65edh5ih/ops-runner/pull/1#discussion_r3651950002) | `.github/actions/net-fetch/net-fetch.sh` | Reject secrets supplied as request IDs | 0日 |
...
| 🔴 | P2 | [#8](https://github.com/65edh5ih/ops-runner/pull/8#discussion_r3652402721) | `docs/cross-repo-tasks.md` | Make completion attainable through the outbox path | 0日 |
| 🔴 | P2 | [#9](https://github.com/65edh5ih/ops-runner/pull/9#discussion_r3652419509) | `docs/ops-sync-design.md` | Reconcile the mechanism description with the two output types | 0日 |
...
走査対象: `65edh5ih/nikki-san` / `65edh5ih/ops-runner` / `65edh5ih/ops-sync` / `65edh5ih/private`。直近 30 日に更新された PR に加え、**前回この一覧に載っていた PR は窓の外でも名指しで再確認する**（＝古くなったからではなく、resolve されたから消える）。

<!-- generated:2026-07-26T11:57:42Z -->
